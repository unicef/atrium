  ...
  return (
    <SectionContainer id="atriumBlockchain" spacing={4} md={8} lg={6}>
      ...
      <Grid id="directLearning" item xs={12}>
        <Box mb="25px">
          <Typography variant="h3">Directed learning</Typography>
        </Box>

        <BorderedTextBoxWithButton
          hideBorder
          buttonLabel="View learning paths"
          onClick={() => setDialogVisibility(true)}
        >
          If you're interested in being guided through tasks that build on basic
          blockchain concepts, the Directed Learning section allows you to
          follow different learning paths and earn points at the same time.
        </BorderedTextBoxWithButton>
        <ActionDialog
